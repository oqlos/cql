...
Verbatim port of ``oqlos/cql/runtime/dsl.xsd.ts`` (the ``DSL_XSD`` export).
The string must stay byte-identical to the TS source so consumers using the
XML can validate against either side without surprises.
"""
from __future__ import annotations

DSL_XSD: str = """<?xml version="1.0" encoding="UTF-8"?>
